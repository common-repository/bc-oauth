...
/**
 *  @version 0.2
 *  @author Niklas Guenther <niklas.guenther@avonis.de>
 * 
 *   bc-oauth is a wordpress plugin, which gives Wordpress, buddypress and bettercodes oAuth functionality
 *   Copyright (C) 2010 - 2011  Niklas Guenther
 *
...
Description: This Plugin grives Wordpress, Buddypress and bettercodes.org oAuth functionality
